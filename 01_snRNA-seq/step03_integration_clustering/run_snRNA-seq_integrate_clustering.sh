...
#---For gsea annotation---
marker1="/path/to/04_scifi_multiome/markers/markers.filtered.v5.txt" #for DEG identification.
...
prefix=Zm_All_seedling_integrated
  ...
  Rscript ./00_integrate_Clustering_RNA_Zm.R $meta_path $rds_path $tissue $prefix
  
  rna_count=${prefix}.rna.sparse.rds
  rna_meta=${prefix}.rna.Singlet.metadata.txt
  rna_id=celltype
  rna_pca=${prefix}.rna.Harmony.txt
  #rna${prefix}.rna.seurat.obj.rds
